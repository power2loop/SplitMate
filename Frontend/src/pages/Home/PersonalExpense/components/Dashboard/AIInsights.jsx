...
const AIInsights = ({ expenses }) => {
  ...
  const generateInsights = () => {
    ...
    const insights = [
      {
        ...
        message:
          "Transportation costs have increased. Consider carpooling or public transit options.",
      },
      {
      ...
      },
      {
        ...
        message:
          "Entertainment expenses are high. Look for free or low-cost activities to balance your budget.",
      },
      {
      ...
      },
      {
        ...
        message:
          "Utility bills are consuming a large portion of your budget. Check for energy-saving opportunities.",
      },
      {
      ...
      },
      {
        ...
        message:
          "You're maintaining excellent spending discipline this month. Keep up the great work!",
      },
    ];
    ...
    return applicableInsight
      ? applicableInsight.message
  ...
  return (
    <div className="ai-insights-card">
      <div className="ai-insights-header">
        <div className="ai-icon">{getAIIcon()}</div>
